...
const projectlists_zh = [
  {
    startTime: '2025.12',
    duration: '2个月',
    title: 'HS-C-BOM数据管理模块',
    company: '歌尔智能科技有限公司',
    role: '开发工程师（全栈）',
    teamSize: '2-3人',
    summary: '负责统一BOM数据管理平台的设计与开发，支持多种BOM格式导入、解析、对比和转换，与PLM系统无缝集成。',
    technologyStack: {
      backend: 'ASP.NET MVC, SqlSugar ORM, DDD领域建模',
      frontend: 'jQuery, HTML, CSS',
      database: 'MySQL, Redis',
      devops: '',
      integration: 'PLM系统API, MES系统数据',
      others: 'NPOI (Excel解析), EPPlus (Excel生成)'
    },
    businessContext: 'NPI阶段Config非常多，客户Build Matrix变化频繁，BOM核对依赖人工，工作量巨大且有较大漏失风险。',
    painPoints: [
      'BOM核对完全依赖人工，每份需要2-4小时，效率低下。',
      '多种BOM格式（Agile、Matrix、GTK等）差异大，对比困难。',
      '版本管理混乱，变更历史难以追踪。'
    ],
    challenges: [
      '需要支持6种以上BOM对比场景，对比逻辑复杂。',
      'GPN重复处理、替代料检查等业务规则繁多。',
      '与PLM系统集成需要字段映射和格式转换。'
    ],
    solutions: [
      '设计统一的BOM数据模型，支持多格式自动解析与标准化。',
      '实现灵活的自定义字段对比引擎，支持高亮单个位号差异。',
      '构建完整的版本控制体系，自动记录变更历史。',
      '开发PLM集成模块，实现CFG BOM自动生成与校验。'
    ],
    impact: [
      'BOM核对时间从2-4小时缩短至15-30分钟，效率提升80%。',
      '漏失风险下降95%，数据准确性显著提高。',
      '版本管理实现自动化追踪，变更可追溯。'
    ],
    outcomes: [
      '统一BOM数据管理平台成功上线，支持HSD和SMT两大业务线。',
      '与PLM系统完全集成，实现自动校验与转换。',
      '建立完整的BOM变更追踪体系。'
    ],
    details: [
      '模块1-HSD BOM：导入FATP完整BOM，自动解析颜色信息，生成树形结构，支持PC/SC组件分离。',
      '模块2-SMT BOM：支持Agile BOM、Build Matrix、GTK Agile BOM、客户CBOM等多种格式导入。',
      '对比功能：自定义字段对比，支持6种对比场景，高亮单个位号差异。',
      'PLM集成：CFG BOM生成、字段映射、GPN匹配、自动校验。',
      '版本控制：BOM版本管理、变更历史记录、版本对比。'
    ],
    pictures: []
  },

  {
    startTime: '2025.11',
    duration: '2个月',
    title: 'HWTE-设备异常监控与处理模块',
    company: '歌尔智能科技有限公司',
    role: '开发工程师（全栈）',
    teamSize: '3人',
    summary: '负责生产线设备异常实时监控系统的设计与开发，实现数据驱动的主动预警、多级通知升级和异常闭环管理。',
    technologyStack: {
      backend: 'ASP.NET MVC, SqlSugar ORM, DDD领域建模',
      frontend: 'Layui, ECharts',
      database: 'MySQL (16张核心表), Redis',
      devops: ' Hangfire (定时任务)',
      integration: 'MES系统, PC系统, Kafka / RabbitMQ',
      others: 'Serilog (日志)'
    },
    businessContext: '生产线设备异常依赖人工被动发现，缺乏实时监控和主动预警机制，需要建立智能运维体系。',
    painPoints: [
      '异常发现依赖人工巡检，响应时间2-4小时。',
      '异常处理流程不透明，责任人不明确。',
      '日常统计和周报制作耗时大量人力。'
    ],
    challenges: [
      '规则引擎需要基于工程日历过滤非工作时间。',
      '防重复报警机制设计，避免同一异常重复通知。',
      'MES数据实时接入与增量处理。'
    ],
    solutions: [
      '设计两种监控规则：无产出超时检测、连续不良检测。',
      '实现基于工程日历的有效工作时间计算，精确排除休息时间。',
      '构建多级通知升级机制（DRI→Leader→部门负责人）。',
      'Redis分片存储过站数据和不良数据，支持高效查询。',
      '防重复报警：异常闭环后才触发下次报警。'
    ],
    impact: [
      '异常发现时间从2-4小时缩短至<5秒，下降95%。',
      '异常处理周期从2-4小时缩短至30分钟内，下降75%。',
      '日常统计和周报制作实现自动化，每天节省3小时。'
    ],
    outcomes: [
      '系统成功与MES、PC系统集成，实时监控覆盖所有生产工位。',
      '异常处理流程自动化、透明化、可追溯。',
      '建立设备异常的数字化底座，为后续数据分析提供基础。'
    ],
    details: [
      '生产线层级管理：项目/线体/工站/工位的CRUD与层级关系管理。',
      '工程日历管理：班次、休息、节假日配置，支持循环模式。',
      '监控规则配置：规则1-无产出超时，规则2-连续不良，升级级别配置。',
      '责任人链管理：多级责任人绑定，超时时间配置。',
      'MES数据接入：过站数据、不良数据增量获取，Redis缓存设计。',
      '规则引擎核心：基于工程日历的有效工作时间计算，防重复报警。',
      '异常工单管理：工单自动创建、状态流转、处理记录。',
      '通知与升级：多渠道通知（App/邮件/短信），时间驱动自动升级。'
    ],
    pictures: []
  },

  {
    startTime: '2025.10',
    duration: '2个月',
    title: '来料不良索赔全流程系统（HS项目）',
    company: '歌尔智能科技有限公司',
    role: '开发工程师（全栈）',
    teamSize: '3人',
    summary: '负责来料索赔全流程线上化系统的设计与开发，实现从发现到财务闭环的完整索赔管理。',
    technologyStack: {
      backend: 'ASP.NET, WebAPI, SqlSugar ORM, DDD',
      frontend: 'Vue 3, Vol.Web, Ant Design Pro',
      database: 'MySQL',
      devops: '',
      integration: 'Sys_WorkFlow (动态配置审批流)',
      others: ''
    },
    businessContext: '来料索赔依赖线下沟通、纸质审批，流程断点多，索赔周期长、损失回收率低。',
    painPoints: [
      '索赔流程依赖线下沟通和纸质审批，效率低下。',
      '索赔周期长，漏算率高，损失回收困难。',
      '供应商质量绩效难以量化评估。'
    ],
    challenges: [
      '复杂多环节审批流设计，需支持并行节点与驳回。',
      '索赔金额核算逻辑复杂，涉及多实体自动计算。',
      '跨系统数据打通与自动反写。'
    ],
    solutions: [
      '设计状态机双向映射（Status↔StepId），支持复杂审批流。',
      '采用DDD模型设计，聚合根+多实体实现索赔金额自动计算。',
      '构建统一DataSync API层，实现跨系统数据自动反写。',
      '多附件上传，自动生成电子档案，支持供应商沟通追溯。',
      '实时看板：金额趋势、TOP10供应商、不良分布可视化。'
    ],
    impact: [
      '索赔周期平均缩短35%。',
      '漏算率下降70%以上。',
    ...
    details: [
      '全流程管理：发现→FA分析→责任判定→成本评估→索赔核算→采购求偿→财务闭环。',
      '审批流设计：状态机双向映射，支持并行节点与驳回。',
      '金额核算：DDD聚合根设计，多实体自动计算。',
      '数据同步：统一DataSync API层，跨系统自动反写。',
      '档案管理：多附件上传，电子档案自动生成。',
      '可视化分析：金额趋势、TOP10供应商、不良分布看板。'
    ],
    pictures: []
  },
...
const projectlists_en = [
  {
    startTime: '2025.12',
    duration: '2 months',
    title: 'BOM Data Management System',
    company: 'Goertek Intelligent Technology Co., Ltd.',
    role: 'Full-Stack Developer',
    teamSize: '2-3 people',
    summary: 'Responsible for the design and development of a unified BOM data management platform, supporting multiple BOM format import, parsing, comparison, and conversion, with seamless PLM system integration.',
    technologyStack: {
      backend: '.NET Core 6 MVC, SqlSugar ORM, DDD Domain Modeling',
      frontend: 'jQuery, HTML, CSS',
      database: 'MySQL, Redis',
      devops: '',
      integration: 'PLM System API, MES System Data',
      others: 'NPOI (Excel Parsing), EPPlus (Excel Generation)'
    },
    businessContext: 'During NPI phase, there are numerous Configs and frequent customer Build Matrix changes. BOM verification relies on manual work, which is labor-intensive with high risk of omissions.',
    painPoints: [
      'BOM verification completely relies on manual work, taking 2-4 hours per BOM, very inefficient.',
      'Multiple BOM formats (Agile, Matrix, GTK, etc.) have significant differences, making comparison difficult.',
      'Version management is chaotic, change history is hard to track.'
    ],
    challenges: [
      'Need to support 6+ BOM comparison scenarios with complex comparison logic.',
      'Numerous business rules including GPN duplicate handling and substitute material checking.',
      'PLM system integration requires field mapping and format conversion.'
    ],
    solutions: [
      'Designed a unified BOM data model supporting multi-format automatic parsing and standardization.',
      'Implemented a flexible custom field comparison engine with single location number difference highlighting.',
      'Built a complete version control system with automatic change history recording.',
      'Developed PLM integration module for automatic CFG BOM generation and validation.'
    ],
    impact: [
      'BOM verification time reduced from 2-4 hours to 15-30 minutes, 80% efficiency improvement.',
      'Omission risk reduced by 95%, data accuracy significantly improved.',
      'Version management achieved automatic tracking with traceable changes.'
    ],
    outcomes: [
      'Unified BOM data management platform successfully launched, supporting both HSD and SMT business lines.',
      'Fully integrated with PLM system, enabling automatic validation and conversion.',
      'Established complete BOM change tracking system.'
    ],
    details: [
      'Module 1 - HSD BOM: Import complete FATP BOM, auto-parse color info, generate tree structure, support PC/SC component separation.',
      'Module 2 - SMT BOM: Support multiple format imports including Agile BOM, Build Matrix, GTK Agile BOM, Customer CBOM.',
      'Comparison Features: Custom field comparison, 6 comparison scenarios, single location number difference highlighting.',
      'PLM Integration: CFG BOM generation, field mapping, GPN matching, automatic validation.',
      'Version Control: BOM version management, change history recording, version comparison.'
    ],
    pictures: []
  },

  {
    startTime: '2025.11',
    duration: '2 months',
    title: 'HWTE Project - Equipment Anomaly Monitoring and Processing System',
    company: 'Goertek Intelligent Technology Co., Ltd.',
    role: 'Full-Stack Developer',
    teamSize: '3 people',
    summary: 'Responsible for the design and development of a real-time production line equipment anomaly monitoring system, implementing data-driven proactive alerting, multi-level notification escalation, and anomaly closed-loop management.',
    technologyStack: {
      backend: '.NET Core 6 MVC, SqlSugar ORM, DDD Domain Modeling',
      frontend: 'Layui, ECharts',
      database: 'MySQL (16 core tables), Redis',
      devops: 'XXL-JOB / Hangfire (Scheduled Tasks)',
      integration: 'MES System, PC System, Kafka / RabbitMQ',
      others: 'Serilog (Logging)'
    },
    businessContext: 'Production line equipment anomalies relied on passive manual discovery, lacking real-time monitoring and proactive alerting mechanisms, requiring an intelligent operations system.',
    painPoints: [
      'Anomaly discovery relied on manual inspection, response time 2-4 hours.',
      'Anomaly handling process was not transparent, responsible persons unclear.',
      'Daily statistics and weekly report preparation consumed significant manpower.'
    ],
    challenges: [
      'Rule engine needs to filter non-working time based on engineering calendar.',
      'Anti-duplicate alerting mechanism design to avoid repeated notifications for the same anomaly.',
      'Real-time MES data integration and incremental processing.'
    ],
    solutions: [
      'Designed two monitoring rules: no-output timeout detection, consecutive defect detection.',
      'Implemented effective working time calculation based on engineering calendar, precisely excluding rest periods.',
      'Built multi-level notification escalation mechanism (DRI→Leader→Department Head).',
      'Redis sharded storage for station pass data and defect data, supporting efficient queries.',
      'Anti-duplicate alerting: next alert only triggered after anomaly closure.'
    ],
    impact: [
      'Anomaly discovery time reduced from 2-4 hours to <5 seconds, 95% reduction.',
      'Anomaly handling cycle reduced from 2-4 hours to within 30 minutes, 75% reduction.',
      'Daily statistics and weekly reports automated, saving 3 hours per day.'
    ],
    outcomes: [
      'System successfully integrated with MES and PC systems, real-time monitoring covers all production stations.',
      'Anomaly handling process automated, transparent, and traceable.',
      'Established digital foundation for equipment anomalies, providing basis for subsequent data analysis.'
    ],
    details: [
      'Production Line Hierarchy Management: CRUD and hierarchy relationship management for Project/Line/Station/WorkPosition.',
      'Engineering Calendar Management: Shift, rest, holiday configuration, supporting cyclic patterns.',
      'Monitoring Rule Configuration: Rule 1 - No output timeout, Rule 2 - Consecutive defects, escalation level configuration.',
      'Responsible Chain Management: Multi-level responsible person binding, timeout configuration.',
      'MES Data Integration: Incremental acquisition of station pass data and defect data, Redis cache design.',
      'Rule Engine Core: Effective working time calculation based on engineering calendar, anti-duplicate alerting.',
      'Anomaly Work Order Management: Automatic work order creation, status flow, handling records.',
      'Notification and Escalation: Multi-channel notification (App/Email/SMS), time-driven automatic escalation.'
    ],
    pictures: []
  },

  {
    startTime: '2025.10',
    duration: '2 months',
    title: 'Incoming Material Defect Claim Full-Process System (HS Project)',
    company: 'Goertek Intelligent Technology Co., Ltd.',
    role: 'Full-Stack Developer',
    teamSize: '3 people',
    summary: 'Responsible for the design and development of a full-process online claim system for incoming materials, implementing complete claim management from discovery to financial closure.',
    technologyStack: {
      backend: '.NET Core, WebAPI, SqlSugar ORM, DDD',
      frontend: 'Vue 3, Vol.Web, Ant Design Pro',
      database: 'MySQL',
      devops: '',
      integration: 'Sys_WorkFlow (Dynamic Approval Flow Configuration)',
      others: ''
    },
    businessContext: 'Incoming material claims relied on offline communication and paper approvals, with many process breakpoints, long claim cycles, and low loss recovery rates.',
    painPoints: [
      'Claim process relied on offline communication and paper approvals, very inefficient.',
      'Long claim cycles, high miscalculation rates, difficult loss recovery.',
      'Supplier quality performance difficult to quantify and evaluate.'
    ],
    challenges: [
      'Complex multi-stage approval flow design, requiring support for parallel nodes and rejection.',
      'Complex claim amount calculation logic involving multi-entity automatic calculation.',
      'Cross-system data integration and automatic write-back.'
    ],
    solutions: [
      'Designed bidirectional state machine mapping (Status↔StepId) supporting complex approval flows.',
      'Adopted DDD model design with aggregate root + multi-entity for automatic claim amount calculation.',
      'Built unified DataSync API layer for cross-system automatic data write-back.',
      'Multi-attachment upload, automatic electronic archive generation, supporting supplier communication traceability.',
      'Real-time dashboard: Amount trends, TOP10 suppliers, defect distribution visualization.'
    ],
    impact: [
      'Average claim cycle reduced by 35%.',
      'Miscalculation rate reduced by over 70%.',
      'Automated task flow between departments, transparent and trackable approvals.'
    ],
    outcomes: [
      'Achieved full-process online closed-loop management (Discovery→FA Analysis→Responsibility Determination→Cost Assessment→Claim Calculation→Procurement Claim→Financial Closure).',
      'Established supplier quality and claim performance database.',
      'Transparent approval process with real-time tracking support.'
    ],
    details: [
      'Full Process Management: Discovery→FA Analysis→Responsibility Determination→Cost Assessment→Claim Calculation→Procurement Claim→Financial Closure.',
      'Approval Flow Design: Bidirectional state machine mapping, supporting parallel nodes and rejection.',
      'Amount Calculation: DDD aggregate root design, multi-entity automatic calculation.',
      'Data Synchronization: Unified DataSync API layer, cross-system automatic write-back.',
      'Archive Management: Multi-attachment upload, automatic electronic archive generation.',
      'Visual Analysis: Amount trends, TOP10 suppliers, defect distribution dashboard.'
    ],
    pictures: []
  },
